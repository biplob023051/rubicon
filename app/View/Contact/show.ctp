...
<div class="staticcontentbg">
    <div class="staticcontentarea">
        ...
        <div class="contactform">
            ...
            <?php echo $this->Form->input('phone', array('label'=>__('Telefon', true), 'div' =>'row')); ?>
            <?php echo $this->Form->input('comments', array('label'=>__('Ihre Nachricht an uns', true), 'div' =>'row')); ?>
            <?php
                if($this->Bookmark->anyBookmarks()):
            ?>
            <div class="clr"></div>
            <div class="highlight"><?php echo __('Sie haben ausgewählte Immobilien auf Ihrer Merkliste gespeichert.'); ?><br /><?php echo __('Möchten Sie für diese Objekte weitere Details anfragen?'); ?></div>
...
<div class="staticcontentbg"><a name="imprint"></a>
    <div class="staticcontentarea">
        ...
        <div class="form_left"> <img src="/img/anfahrt.png" /> </div>
