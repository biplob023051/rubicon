<?php
    ...
    foreach($cats as $cat){
        ...
        if(
            isset($this->params['controller']) && $this->params['controller'] == 'gesamtobjekt' && isset($this->params['action'])
            && $this->params['action'] == 'search' || $this->params['action'] == 'show'
        ){
            if(
...
?>
<ul class="topnav">
    <li><?=$this->Html->link(__('Schnell-Suche'), '#');?>
        <ul class="innerul">
            <?=$listCats;?>
        </ul>
    </li>
    <li><?=$this->Html->link(__('Detail-Suche'), '#', array('class' => $activeMenu));?>
        <ul class="innerul">
                ...
                <div id="scrollbar1">
                    ...
                    <?php
                        foreach($cities as $city){
                            if($city['Regionen']['REG_ID'] == 1) continue;
                            ...
                            if($city[0]['BER_NAME'] == null){
                                ...
                                echo '<li>'.$this->Html->link(
                                                            $city['Regionen']['REG_NAME'],
                                                            $this->Flags->changeUrl(
                                                                $this->Session->read('Config.language'),
                                                                array('controller' => 'gesamtobjekt', 'action' => 'search'), true,
                                                                Inflector::slug($city['Regionen']['REG_NAME'])
                                                                    //array('r' => $city['Regionen']['REG_ID'])
                                                            )
                                                        , array('class' => $activeItem, 'rel' => 'r'.$city['Regionen']['REG_ID'])).'</li>'; $activeItem ='';
                            }

                            if($city[0]['BER_NAME']) $last_reg_id = $city['Regionen']['REG_ID'];
                                ...
                                echo '<li>'.$this->Html->link(
                                                        $city[0]['BER_NAME'],
                                                            $this->Flags->changeUrl(
                                                                $this->Session->read('Config.language'),
                                                                array('controller' => 'gesamtobjekt', 'action' => 'search'), true,
                                                                    Inflector::slug($city[0]['BER_NAME'])
            ...
            <li class="sub" id="detailPrices"><a href="#" class="<?php echo __('Alle Preise'); ?>"><?php echo __('Alle Preise'); ?></a>
                <?php
                    if(isset(
                            $this->params['controller']) && $this->params['controller'] == 'gesamtobjekt' && isset($this->params['action'])
                            && $this->params['action'] == 'search' || $this->params['action'] == 'show'
                    ){
                        if(
                            ...
                            if(isset($this->params['named']['p']) && $this->params['named']['p'] ==  1 || isset($menuSel) && $menuSel['price'] == 1) $activeItem1 = 'selItem';
                            if(isset($this->params['named']['p']) && $this->params['named']['p'] ==  2 || isset($menuSel) && $menuSel['price'] == 2) $activeItem2 = 'selItem';
                            if(isset($this->params['named']['p']) && $this->params['named']['p'] ==  3 || isset($menuSel) && $menuSel['price'] == 3) $activeItem3 = 'selItem';
                            if(isset($this->params['named']['p']) && $this->params['named']['p'] ==  4 || isset($menuSel) && $menuSel['price'] == 4) $activeItem4 = 'selItem';
                            if(isset($this->params['named']['p']) && $this->params['named']['p'] ==  5 || isset($menuSel) && $menuSel['price'] == 5) $activeItem5 = 'selItem';
                            if(isset($this->params['named']['p']) && $this->params['named']['p'] ==  6 || isset($menuSel) && $menuSel['price'] == 6) $activeItem6 = 'selItem';
                        }
                    }
                ?>
                <ul>
                    <li><?=$this->Html->Link(__('bis 1 Mio. €'), $this->Flags->changeUrl(
                                                                                    $this->Session->read('Config.language'),
                                                                                    array('controller' => 'gesamtobjekt', 'action' => 'search'), true,
                                                                                        Inflector::slug(__('bis 1 Mio. €')),
                                                                                        array('p' => 1)
                                                                                ), array('class' => $activeItem1, 'rel' => 1))?></li>
                    <li><?=$this->Html->Link(__('bis 2 Mio. €'), $this->Flags->changeUrl(
                                                                                    $this->Session->read('Config.language'),
                                                                                    array('controller' => 'gesamtobjekt', 'action' => 'search'), true,
                                                                                        Inflector::slug(__('bis 2 Mio. €')),
                                                                                        array('p' => 2)
                                                                                ), array('class' => $activeItem2, 'rel' => 2))?></li>
                    <li><?=$this->Html->Link(__('bis 3 Mio. €'), $this->Flags->changeUrl(
                                                                                    $this->Session->read('Config.language'),
                                                                                    array('controller' => 'gesamtobjekt', 'action' => 'search'), true,
                                                                                        Inflector::slug(__('bis 3 Mio. €')),
                                                                                        array('p' => 3)
                                                                                ), array('class' => $activeItem3, 'rel' => 3))?></li>
                    <li><?=$this->Html->Link(__('bis 4 Mio. €'), $this->Flags->changeUrl(
                                                                                    $this->Session->read('Config.language'),
                                                                                    array('controller' => 'gesamtobjekt', 'action' => 'search'), true,
                                                                                        Inflector::slug(__('bis 4 Mio. €')),
                                                                                        array('p' => 4)
                                                                                ), array('class' => $activeItem4, 'rel' => 4))?></li>
                    <li><?=$this->Html->Link(__('bis 5 Mio. €'), $this->Flags->changeUrl(
                                                                                    $this->Session->read('Config.language'),
                                                                                    array('controller' => 'gesamtobjekt', 'action' => 'search'), true,
                                                                                        Inflector::slug(__('bis 5 Mio. €')),
                                                                                        array('p' => 5)
                                                                                ), array('class' => $activeItem5, 'rel' => 5))?></li>
                    <li><?=$this->Html->Link(__('ab 5 Mio. €'), $this->Flags->changeUrl(
                                                                                    $this->Session->read('Config.language'),
                                                                                array('controller' => 'gesamtobjekt', 'action' => 'search'), true,
                                                                                        Inflector::slug(__('ab 5 Mio. €')),
                                                                                        array('p' => 6)
                                                                                ), array('class' => $activeItem6, 'rel' => '6'))?></li>
                </ul>
            </li>
            <li id="ref"><a href="#"><?php echo __('Referenz-Nr.'); ?></a>
                ...
                ?>
                <div><input name="suche" class="refsearch" type="text" value="<?=$ref?>" rel="<?=Inflector::slug(__('Immobilien Suche nach Referenznummer'))?>" /></div>
            </li>
            <li><a href="#" >
    ...
    <li style="padding-top: 284px;">
        <?=$this->Html->link(__('VIP Special'), array('controller' => 'content', 'action' => 'vip', 'language' => $this->Session->read('Config.language'), 'slug' => Inflector::slug(__('VIP Special'))), array('id' => 'vipLink'));?>
    </li>
</ul>