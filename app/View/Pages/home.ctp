...
<div class="content clearfix">
    ...
    <span class="signatures <?php echo CakeSession::read('Config.language'); ?>"><?php echo __('Herzlich Willkommen'); ?></span>
...
<div class="content clearfix">
    ...
    <?php if (CakeSession::read('Config.language') == 'deu'): ?>
        <div style="font-size: 13px;line-height: 17px;" class="content_box_fullwidth clearfix">
