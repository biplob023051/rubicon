...
?>
<div class="banner"><img src="/img/banner_20.jpg" alt="" class="img-responsive"/></div>
...
<div class="staticcontent">
    <div class="staticcontentarea">
        ...
        <div class="row clearfix">
            <div class="col-md-3 col-sm-3 blogs">
                <img src="/img/team/Markus-Redlich.jpg" alt="<?php echo __('Immobilienmakler Markus Redlich'); ?>" class="img-responsive"/>
                <p>
                    Markus Redlich<br />
                    <?php echo __('Inhaber + CEO'); ?><br />
                    +34 971 69 81 49<br />
                    <?php echo __('SMS Rückruf-Service'); ?><br /><br />
                    <?php echo $this->Mailto->encode('markus@finestpropertiesmallorca.com', __('E-Mail senden', true), 'mailicon'); ?>
                </p>
            </div>
            <div class="col-md-3 col-sm-3 blogs">
                <img src="/img/team/Volker-Schupp.jpg" alt="<?php echo __('Sales Manager Volker Schupp'); ?>" class="img-responsive"/>
                <p>
                    Volker Schupp<br />
                    <?php echo __('Sales Manager'); ?><br />
                    +34 971 69 81 49<br /><br /><br />
                    <?php echo $this->Mailto->encode('info@finestpropertiesmallorca.com', __('E-Mail senden', true), 'mailicon'); ?>
                </p>
            </div>
            <div class="col-md-3 col-sm-3 blogs">
                <img src="/img/team/Cornelia-Schaedlich.jpg" alt="<?php echo __('Office Manager Cornelia Schädlich'); ?>" class="img-responsive"/>
                <p>
                    Cornelia Schädlich<br />
                    <?php echo __('Office Manager'); ?><br />
                    +34 971 69 81 49<br /><br /><br />
                    <?php echo $this->Mailto->encode('info@finestpropertiesmallorca.com', __('E-Mail senden', true), 'mailicon'); ?>
                </p>
            </div>
            <div class="col-md-3 col-sm-3 blogs">
                <img src="/img/team/Elena-Pyatnitsa.jpg" alt="Elena Pyatnitsa" class="img-responsive"/>
                <p>
                    Elena Pyatnitsa<br /><br />
                    +34 971 69 81 49<br /><br /><br />
                    <?php echo $this->Mailto->encode('info@finestpropertiesmallorca.com', __('E-Mail senden', true), 'mailicon'); ?>
                </p>
            </div>
