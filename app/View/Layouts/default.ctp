...
<html lang="<?php echo CakeSession::read('Config.language'); ?>">
    ...
    <body class="<?php echo CakeSession::read('Config.language'); ?>">
        <div class="header" id="mainHeader">
            <?php echo $this->Html->link($this->Html->Image('Immobilien-Mallorca-Finest-Properties-Mallorca.png', array('class' => 'logo', 'alt' => __('Immobilienmakler Finest Properties'))), $this->Flags->changeUrl($this->Session->read('Config.language'), '/'), array('escape' => false)); ?>
            <div class="top_nav">
                <ul>
                    <li><?php echo $this->Html->link(__('Start'), $this->Flags->changeUrl($this->Session->read('Config.language'), '/')); ?></li>
                    <li><?php echo $this->Html->link(__('Newsletter'), '#' . __('Newsletter'), array('class' => 'modalInput', 'id' => 'newsletterWindow', 'rel' => '#news')); ?></li>
                    <li>
        ...
        <div class="device clearfix" id="main-body">
            ...
            <div class="col-md-9 col-sm-10 no-pad-lft">
