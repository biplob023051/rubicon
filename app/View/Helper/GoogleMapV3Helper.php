<?php
/**
 * This is a CakePHP helper that helps user to integrate google map v3
...
class GoogleMapV3Helper extends AppHelper {
	...
	protected $_defaultOptions = array(
		'zoom' =>9, # global, both map and staticMap
		'lat' => 39.57817336212527, # global, both map and staticMap
		'lng' => 2.6531982421875, # global, both map and staticMap
		'type' => 'R',	
		'map'=>array(
			'api' => null,
...
/** Google Maps JS **/
	...
	function map($options = array()) {
		...
		$map .= "
			...
			";
        ////////
        //$map .= $this->name().".event.trigger(maps, 'resize');";
        ////////
		$this->map = $map;
